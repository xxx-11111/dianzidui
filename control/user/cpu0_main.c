...
#define ENCODER_QUADDEC                 (TIM5_ENCODER)                         // 正交编码器对应使用的编码器接口
#define ENCODER_QUADDEC_A               (TIM5_ENCODER_CH1_P10_3)               // A 相对应的引脚
#define ENCODER_QUADDEC_B               (TIM5_ENCODER_CH2_P10_1)               // B 相对应的引脚
